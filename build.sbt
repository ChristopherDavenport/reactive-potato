...
lazy val releaseSettings = {
  ...
  Seq(
    ...
    scmInfo := Some(
      ScmInfo(
        url("https://github.com/ChristopherDavenport/reactive-potato"),
        "git@github.com:ChristopherDavenport/reactive-potato.git"
      )
    ),
    homepage := Some(url("https://github.com/ChristopherDavenport/reactive-potato")),
